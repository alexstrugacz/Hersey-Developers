...
const LearnSkills: React.FC<{}> = () => {
    return (
        <div className=" bg-zinc-200 shadow-md overflow-hidden">
            <div className="flex">
                <img className="w-1/2 m-12" src={learnskills}></img>
                <div className="w-1/2 m-12">
                    <h3 className=" mt-24 text-left font-Grotesk font-bold text-4xl">Learn new <a className="text-teal-600">coding skills</a></h3>
