    ...
    return (
        <div className="flex bg-zinc-300 shadow-md overflow-hidden">
            <div className="flex flex-col items-center w-full mx-auto p-10 pb-5 mb-10 text-4xl">
                ...
                <p className="md:w-5/12 text-xl font-UI text-slate-800 mt-5 ">Hersey Developers is a <a className="font-bold">remote, 60-hour</a> software engineering internship. All levels of experience are welcome, and laptops are provided if necessary!</p>
            </div>
        </div>
    )
}
